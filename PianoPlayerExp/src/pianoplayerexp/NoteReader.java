...
public class NoteReader {
    ...
    public NoteReader(int bro) {
        FileReader reader;
        if (bro == 0) {
            reader = new FileReader("src/pianoplayerexp/FurElise.txt");
        } else if (bro == 1) {
            reader = new FileReader("src/pianoplayerexp/PiratesOfTheCaribbean.txt");
        } else if (bro == 2) {
            reader = new FileReader("src/pianoplayerexp/iPhone.txt");
        } else {
            reader = new FileReader("src/pianoplayerexp/MaryHadALittleLamb.txt");
        }
        myNotes = reader.data;
